...
import 'package:hr_dispatcher/data/source/network/model/notice/NoticeDomain.dart';
import 'package:hr_dispatcher/data/source/network/model/notice/NoticeResponse.dart';
...
class NoticeProvider with ChangeNotifier {
  ...
  Future<NoticeResponse> getNotice() async {
    var uri = Uri.parse(Constant.NOTICE_URL).replace(queryParameters: {
      'page': page.toString(),
