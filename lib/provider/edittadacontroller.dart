...
import 'package:hr_dispatcher/data/source/network/model/tadadetail/tadadetailresponse.dart';
...
class EditTadaController extends GetxController {
  ...
  Future<String> editTada() async {
    try{
      var uri = Uri.parse(Constant.TADA_UPDATE_URL);
  ...
  Future<void> removeAttachment(int id,int index) async {
    var uri =
    Uri.parse(Constant.TADA_DELETE_ATTACHMENT_URL + "/$id");
