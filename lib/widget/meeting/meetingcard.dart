import 'package:hr_dispatcher/data/source/network/model/meeting/Participator.dart';
import 'package:hr_dispatcher/screen/profile/meetingdetailscreen.dart';
import 'package:hr_dispatcher/widget/meeting/meetingparticipator.dart';
...
class MeetingCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: () {
        Navigator.pushNamed(context, MeetingDetailScreen.routeName,
            arguments: id);
      },
      child: Card(
